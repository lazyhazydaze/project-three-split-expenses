...
import { auth, database, storage, dbRef  } from './firebase'
...
export const Homepage = () => {
    ...
    const uploadImage = (e) => {
        e.preventDefault()
        const profilePicRef = storageref(storage, `userdata/${username}/profilePicture`)
  ...
  return (
    <>  
        <div style={{postion:"fixed"}}>
            ...
            <div>
                <img src={photoURL == null ? "https://media.istockphoto.com/id/1214428300/vector/default-profile-picture-avatar-photo-placeholder-vector-illustration.jpg?s=612x612&w=0&k=20&c=vftMdLhldDx9houN4V-g3C9k0xl6YeBcoB_Rk6Trce0=" : `${photoURL}`}/>
            ...
            <div ref={popupwindow} className={"popup"}>
                <div className="popup_content">
                    ...
                    <img onClick={displayUploadImageForm} className='pfp' src={photoURL == null ? "https://media.istockphoto.com/id/1214428300/vector/default-profile-picture-avatar-photo-placeholder-vector-illustration.jpg?s=612x612&w=0&k=20&c=vftMdLhldDx9houN4V-g3C9k0xl6YeBcoB_Rk6Trce0=" : `${photoURL}`}/>
                    <br/>
                    <button style={photoURL == null?{display:"none"}:{display:"block"}} onClick={removeProfilePicture}>Remove picture</button>
                    <br/>
                    <span>Username: {`${username}`}</span> 
                    <span className='edit' onClick={editUsername}>Edit</span>
                    <p>Registered Email: {`${email}`}</p>
                    
                    <div ref={uploadimagewindow} className={'uploadImageForm'} > 
                        <span>choose your picture</span>
                        <span className="close" onClick={closeUploadImageForm}>&times;</span> 
